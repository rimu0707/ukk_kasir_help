...
<div class="card mt-2">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6"> <!-- Mengubah ukuran kolom dari 4 ke 6 untuk mengisi ruang yang sebelumnya digunakan oleh Data Pengguna -->
                <div class="card">
                    <div class="card-body">
                        Data Barang
                        <?php
            ...
            <div class="col-sm-6"> <!-- Mengubah ukuran kolom dari 4 ke 6 -->
                <div class="card">
                    <div class="card-body">
                        Data Pembelian
                        <?php
